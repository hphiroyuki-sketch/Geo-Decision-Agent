...
export default function DisclosureWorkspace(){
  ...
  return <div className="p-4 sm:p-6 max-w-7xl mx-auto space-y-5">
    ...
    {data&&<div className="rounded-2xl bg-[#112d2d] text-white p-5 grid sm:grid-cols-4 gap-4">
